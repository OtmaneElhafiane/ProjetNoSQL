...
class Config:
    ...
    NEO4J_PASSWORD = os.getenv('NEO4J_PASSWORD', '6HMkNw9Oh2s3xX_rH4I9DV4ZT-rSN_z8lsQ24MeZKAg')
...
class TestConfig(Config):
    ...
    NEO4J_URI = os.environ.get('NEO4J_TEST_URI', 'neo4j+s://236ac439.databases.neo4j.io')
    NEO4J_USER = os.environ.get('NEO4J_TEST_USER', 'neo4j')
    NEO4J_PASSWORD = os.environ.get('NEO4J_TEST_PASSWORD', '6HMkNw9Oh2s3xX_rH4I9DV4ZT-rSN_z8lsQ24MeZKAg')
